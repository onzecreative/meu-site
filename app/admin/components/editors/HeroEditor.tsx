      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="mt-6">
              <label className="text-xs font-bold text-white/40 uppercase mb-2 block">Overlay Opacity ({data.background.opacity}%)</label>
              <input 
                type="range" 
                min="0" max="90" 
        ...
        <div className="sticky top-24">
          <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden aspect-video relative flex items-center justify-center p-12 text-center">
             ...
             <div className="absolute inset-0 bg-black" style={{ opacity: data.background.opacity / 100 }} />
